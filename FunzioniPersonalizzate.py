...
#     Spett.le ACCORD HEALTHCARE ITALIA SRL,

# in riferimento a quanto in oggetto, si comunica che con DDT n. 29373 del 22/10/2025 - in allegato - (rif. nostro ordine n. DPC-2025-1466 del 22/10/2025) sono stati consegnati:

# N. 4400 conf. di DABIGATRAN ETE ACC*60CPS 150MG - 050696234 con scadenza ravvicinata (Lotto DRE07334A - Scadenza 30/06/2027), inferiore a DUE TERZI della scadenza nominale del prodotto;
# N. 5845 conf. di DABIGATRAN ETE ACC*60CPS 110MG - 050696145 con scadenza ravvicinata (Lotto DRE08557A - Scadenza 31/07/2027), inferiore a DUE TERZI della scadenza nominale del prodotto;
# N. 155 conf. di DABIGATRAN ETE ACC*60CPS 110MG - 050696145 con scadenza ravvicinata (Lotto DRE08556A - Scadenza 31/07/2027), inferiore a DUE TERZI della scadenza nominale del prodotto;
# N. 100 conf. di PELGRAZ*SC 1INIET 6MG 0,6ML - 047090028 con scadenza ravvicinata (Lotto G2401263 - Scadenza 30/04/2027), inferiore a DUE TERZI della scadenza nominale del prodotto;

# Valutati i consumi della DPC di Area Vasta Regione Veneto, il Servizio scrivente si rende disponibile a trattenere la merce, con richiesta di Vs impegno al reso/nota di accredito della quantità eventualmente rimanente al:

# 30/04/2027 per DABIGATRAN ETE ACC*60CPS 150MG - 050696234 data ultima di utilizzo del prodotto nella catena di distribuzione DPC.
# 31/05/2027 per DABIGATRAN ETE ACC*60CPS 110MG - 050696145 data ultima di utilizzo del prodotto nella catena di distribuzione DPC.
# 31/05/2027 per DABIGATRAN ETE ACC*60CPS 110MG - 050696145 data ultima di utilizzo del prodotto nella catena di distribuzione DPC.
# 28/02/2027 per PELGRAZ*SC 1INIET 6MG 0,6ML - 047090028 data ultima di utilizzo del prodotto nella catena di distribuzione DPC.

# Si ringrazia anticipatamente per la collaborazione e, in attesa di un Vostro riscontro, si porgono cordiali saluti.
